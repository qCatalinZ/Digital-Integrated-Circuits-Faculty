...
HD_PWD='/home/student/Desktop/Zarcan_Catalin/lab1_circuit_simplu/lab1_circuit_simplu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log circuit_simplu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source circuit_simplu.tcl
